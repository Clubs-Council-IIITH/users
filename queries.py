...
def userProfile(
    ...
    Searched on the basis of the uid given as input or the currently logged user's uid.
...
def usersByRole(
    ...
    """
    This method is used to get the metadata of all users belonging to the given input role.
