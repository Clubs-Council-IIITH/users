...
def updateRole(roleInput: RoleInput, info: Info) -> bool:
    ...
    Returns:
        True if the role is updated successfully, False otherwise.
...
def updateUserPhone(userDataInput: PhoneInput, info: Info) -> bool:
    ...
    Returns:
        True if the phone number is updated successfully,
            False otherwise.
...
def updateUserData(userDataInput: UserDataInput, info: Info) -> bool:
    ...
    Returns:
        True if the data is updated successfully, False otherwise.
